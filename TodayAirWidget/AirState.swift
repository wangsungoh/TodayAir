...
class AirState: NSObject {
    ...
    func setupReachability() {
        let hostName = "http://openapi.airkorea.or.kr/"
        ...
        reachability?.whenReachable = { reachability in
            self.showAlertWhenReachable(reachability)
        }
        
        reachability?.whenUnreachable = { reachability in
            self.showAlertWhenNotReachable(reachability)
        }
    }
    
    func showAlertWhenReachable(reachability: Reachability) {
        print("\(reachability.description) - \(reachability.currentReachabilityString)")
        isNetworkReachable = true
    }
    
    func showAlertWhenNotReachable(reachability: Reachability) {
        print("\(reachability.description) - \(reachability.currentReachabilityString)")
